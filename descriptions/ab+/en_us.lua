...
EID.descriptions[languageCode].AdditionalInformations = {
	...
	[C_ID .. 34] = "{{AngelDevilChance}} +12.5% Devil/Angel Room chance while held#{{Timer}} Receive for the room:#↑ {{Damage}} +2 Damage", -- The Book of Belial
	...
	[C_ID .. 37] = "Drops a large bomb below Isaac which deals 110 damage", -- Mr. Boom
	...
	[C_ID .. 40] = "Causes an explosion at Isaac's location#It deals 40 damage", -- Kamikaze!
	...
	[C_ID .. 58] = "{{Timer}} Invincibility for 10 seconds", -- Book of Shadows
	...
	[C_ID .. 72] = "{{Collectible33}} The Bible is added to all item pools", -- Rosary
	...
	[C_ID .. 77] = "{{Timer}} Receive for 6 seconds:#↑ {{Speed}} +0.28 Speed#Invincibility#Isaac can't shoot but deals 40 contact damage per second", -- My Little Unicorn
	...
	[C_ID .. 83] = "Upon use:#{{SoulHeart}} +1 Soul Heart#{{Timer}} Receive for the room:#↑ {{Damage}} +0.7 Damage#↓ {{Speed}} -0.18 Speed#Isaac deals 40 contact damage per second#Allows Isaac to destroy rocks by walking into them", -- The Nail
	...
	[C_ID .. 98] = "{{SoulHeart}} Spawns 1 Soul Heart every 5-6 rooms", -- The Relic
	[C_ID .. 99] = "{{Slow}} Shoots slowing tears", -- Little Gish
	[C_ID .. 100] = "Shoots homing tears", -- Little Steven

	[C_ID .. 103] = "{{Poison}} 25% chance to shoot poison tears#{{Luck}} 100% chance at 12 luck", -- The Common Cold
	...
	[C_ID .. 107] = "{{Timer}} Receive for the room:#Flight#Isaac's body separates from his head and attacks enemies with 82.5 contact damage per second", -- The Pinking Shears
	...
	[C_ID .. 110] = "{{Petrify}} 20% chance to shoot petrifying tears#{{Luck}} 50% chance at 20 luck", -- Mom's Contacts
	...
	[C_ID .. 122] = "When on half a Red Heart or less:#↑ {{Speed}} +0.3 Speed#↑ {{Damage}} +1.5 Damage", -- Whore of Babylon
	...
	[C_ID .. 148] = "Taking damage spawns 1-3 blue flies", -- Infestation
	[C_ID .. 149] = "Isaac's tears are shot in an arc#{{Poison}} The tears explode and poison enemies where they land", -- Ipecac
	[C_ID .. 150] = "{{Damage}} 10% chance to shoot teeth that deal 3.2x Isaac's damage#{{Luck}} 100% chance at 9 luck", -- Tough Love
	...
	[C_ID .. 154] = "↑ {{Damage}} +2 Damage for the left eye", -- Chemical 
	...
	[C_ID .. 170] = "Stomps on a nearby enemy every 4 seconds#Deals 40 damage per second", -- Daddy Longlegs
	[C_ID .. 171] = "{{Slow}} Slows down enemies for 4 seconds#Deals 10 damage to all enemies", -- Spider Butt
	[C_ID .. 173] = "{{SoulHeart}} 50% chance that Red Hearts spawn as Soul Hearts instead", -- Mitre
	...
	[C_ID .. 192] = "{{Timer}} Homing tears for the room", -- Telepathy For Dummies
	[C_ID .. 198] = "Spawns 1 pickup of each type", -- Box
	[C_ID .. 199] = "Chests contain more pickups", -- Mom's Key
	[C_ID .. 200] = "{{Charm}} 10% chance to shoot charming tears#{{Luck}} 100% chance at 27 luck", -- Mom's Eyeshadow
	
	[C_ID .. 201] = "{{Confusion}} 10% chance to shoot concussive tears#{{Luck}} 100% chance at 27 luck", -- Iron Bar
	...
	[C_ID .. 206] = "Isaac's head becomes an orbital that shoots, doesn't take damage and deals 105 contact damage per second", -- Guillotine
	...
	[C_ID .. 211] = "Taking damage spawns 1-2 blue spiders", -- Spiderbaby
	...
	[C_ID .. 217] = "5% chance to spawn a blue spider when shooting tears#{{Luck}} 100% chance at 10 luck", -- Mom's Wig
	[C_ID .. 218] = "{{HealingRed}} 50% chance to heal half a heart every minute", -- Placenta
	[C_ID .. 219] = "{{Heart}} Taking damage has a 10% chance to spawn a Red Heart", -- Old Bandage
	...
	[C_ID .. 231] = "{{Slow}} 10% chance to shoot slowing tears#{{Luck}} 100% chance at 18 luck#{{Slow}} Isaac leaves a trail of slowing creep", -- Ball of Tar
	[C_ID .. 232] = "{{Slow}} Taking damage slows all enemies in the room permanently", -- Stop Watch
	[C_ID .. 233] = "Spectral tears#Isaac's tears orbit around him", -- Tiny Planet
	...
	[C_ID .. 254] = "↑ {{Damage}} +1 Damage for the left eye#↑ {{Range}} +5 Range for the left eye", -- Blood Clot
	[C_ID .. 256] = "{{Burning}} Isaac's bombs leave a flame where they explode", -- Hot Bombs
	[C_ID .. 257] = "{{Burning}} Isaac's tears light enemies on fire#10% chance for tears to explode on enemy impact#{{Luck}} 100% chance at 13 luck#{{Warning}} The explosion can hurt Isaac", -- Fire Mind
	[C_ID .. 258] = "Rerolls all of Isaac's items and stats on pickup and at every new floor", -- Missing No.
	[C_ID .. 259] = "{{Fear}} 33% chance to shoot fear tears#{{Luck}} 100% chance at 20 luck", -- Dark Matter
	...
	[C_ID .. 272] = "Friendly exploding fly#The explosion deals 60 damage#{{Warning}} The explosion can hurt Isaac", -- BBF
	[C_ID .. 273] = "Dashes in the direction Isaac is shooting#Explodes when it hits an enemy#{{Poison}} The explosion deals 60 damage and poisons enemies#{{Warning}} The explosion can hurt Isaac", -- Bob's Brain
	[C_ID .. 274] = "Taking damage spawns one midrange orbital for the room", -- Best Bud
	[C_ID .. 275] = "{{Chargeable}} Familiar that charges and shoots a {{Collectible118}} blood beam#It deals 31.5 damage over 0.63 seconds", -- Lil Brimstone
	...
	[C_ID .. 287] = "{{Timer}} Grants one of these effects for the floor:#{{Collectible54}} Treasure Map#{{Collectible21}} Compass#{{Collectible246}} Blue Map", -- Book of Secrets
	...
	[C_ID .. 293] = "{{Collectible118}} Shoot a 4-way blood beam#They each deal 440 damage over 1.33 seconds", -- Head of Krampus
	[C_ID .. 294] = "Knocks back nearby enemies and projectiles#10% chance to turn into the stronger {{Collectible484}} Wait What? when swapping it with a different active item and picking it up again", -- Butter Bean
	...
	[C_ID .. 298] = "{{Timer}} Receive for 6 seconds:#↑ {{Speed}} +0.28 Speed#Invincibility#Isaac can't shoot (No contact damage)", -- Unicorn Stump
	...
	[C_ID .. 305] = "{{Poison}} Poison tears", -- Scorpio
	[C_ID .. 306] = "Piercing tears", -- Sagittarius
	...
	[C_ID .. 316] = "Charged wave of 4 tears#{{Warning}} Taking damage while partially charged teleports Isaac to a random room", -- Cursed Eye
	...
	[C_ID .. 331] = "Homing tears#{{Damage}} Tears gain an aura that deals 4.5x Isaac's damage per second", -- Godhead
	...
	[C_ID .. 336] = "Piercing + spectral tears", -- Dead Onion
	...
	[C_ID .. 349] = "{{Coin}} 56% chance to spawn a random coin", -- Wooden Nickel
	...
	[C_ID .. 358] = "Spectral tears#Isaac shoots 2 tears at once diagonally", -- The Wiz
	...
	[C_ID .. 366] = "Isaac's bombs scatter into 2-4 tiny bombs", -- Scatter Bombs
	...
	[C_ID .. 369] = "Spectral tears#Tears can travel through one side of the screen and come out the other side", -- Continuum
	...
	[C_ID .. 374] = "10% chance to shoot holy tears, which spawn a beam of light on hit#{{Luck}} 50% chance at 9 luck#{{Damage}} The beam deals 4x Isaac's damage", -- Holy Light
	...
	[C_ID .. 379] = "Spectral tears", -- Pupula Duplex
	...
	[C_ID .. 410] = "3.33% chance to shoot an eye#{{Luck}} 10% chance at 20 luck#The eye moves in a straight line and shoots tears in the same direction as Isaac", -- Evil Eye
	...
	[C_ID .. 415] = "If Isaac has no damaged heart containers:#↑ {{Damage}} x2 Damage multiplier#↑ {{Range}} +5.25 Range#↑ +0.5 Tear height#↓ {{ShotSpeed}} -0.3 Shot speed#Taking any damage removes the effect for the room", -- Crown Of Light
	...
	[C_ID .. 419] = "Teleports Isaac to a room that has not been cleared yet#Hierarchy: {{Room}}>{{BossRoom}}>{{SuperSecretRoom}}>{{Shop}}>{{TreasureRoom}}>{{SacrificeRoom}}> {{DiceRoom}}>{{Library}}>{{CursedRoom}}>{{MiniBoss}}>{{ChallengeRoom}}{{BossRushRoom}}>{{IsaacsRoom}}{{BarrenRoom}}> {{ArcadeRoom}}>{{ChestRoom}}>{{SecretRoom}}>{{DevilRoom}}{{AngelRoom}}>{{ErrorRoom}}", -- Teleport 2.0
	...
	[C_ID .. 426] = "Mimics Isaac's exact movement on a 3 second delay", -- Obsessed Fan
	...
	[C_ID .. 430] = "Mimics Isaac's movement on a 1 second delay#Shoots tears at nearby enemies that deal Isaac's damage", -- Papa Fly
	[C_ID .. 431] = "Mimics Isaac's movement on a 2 second delay#Tears that pass through it are doubled and gain a range + shot speed boost", -- Multidimensional Baby
	...
	[C_ID .. 439] = "While held:#↑ {{Luck}} +1 Luck#{{Trinket}} Doubles trinket effects", -- Mom's Box
	...
	[C_ID .. 442] = "While at 1 full Red Heart:#↑ {{Tears}} +0.75 Tears#↑ {{Range}} +1.5 Range#↑ +1 Tear height#↑ {{ShotSpeed}} +0.2 Shot speed", -- Dark Prince's Crown
	[C_ID .. 443] = "{{Damage}} 6.66% chance to shoot razor blades that deal 4x Isaac's damage#{{Luck}} 100% chance at 14 luck", -- Apple!
	...
	[C_ID .. 459] = "20% chance to shoot a sticky booger#{{Damage}} Boogers deal Isaac's damage once a second and stick for 60 seconds#{{Luck}} Not affected by luck", -- Sinus Infection
	[C_ID .. 460] = "{{Confusion}} 5% chance to shoot concussive tears#Makes the screen slightly darker", -- Glaucoma
	[C_ID .. 461] = "15% chance to shoot egg sacks#{{Luck}} 50% chance at 5 luck#{{Slow}} Egg sacks spawn slowing creep and a blue spider or fly on hit", -- Parasitoid
	[C_ID .. 462] = "Piercing tears#Hitting an enemy makes the tear homing and doubles its damage", -- Eye of Belial
	...
	[C_ID .. 468] = "Follows Isaac's movement on a 1 second delay#Deals 30 contact damage per second#{{Friendly}} After it deals 600 damage, it is absorbed by Isaac, increasing his contact damage and spawning friendly Chargers", -- Shade
	...
	[C_ID .. 471] = "{{Chargeable}} Charges a shotgun attack similar to {{Collectible229}} Monstro's Lung#Each tear deals 3.5 damage", -- Lil Monstro
	...
	[C_ID .. 475] = "Deals 9,999,999 damage to all enemies#{{Warning}} Kills Isaac 3 seconds later", -- Plan C
	...
	[C_ID .. 487] = "{{EmptyHeart}} Removes 1 heart container for:#↑ {{Damage}} +0.2 Damage#{{Collectible73}} A Cube of Meat#{{Timer}} Receive for the room:#↑ {{Range}} +5 Range#{{Collectible214}} Leave a trail of blood creep", -- Potato Peeler
	...
	[C_ID .. 491] = "{{Pill}} Spawns a random pill every 3 rooms#{{Poison}} Using a pill poisons all enemies in the room", -- Acid Baby
	[C_ID .. 492] = "Highlights the location of {{SecretRoom}} secret rooms, tinted rocks and {{LadderRoom}} crawlspaces", -- YO LISTEN!
	[C_ID .. 493] = "For every empty heart container:#↑ {{Damage}} +0.2 Damage", -- Adrenaline
	...
	[C_ID .. 496] = "3.33% chance to shoot a needle#{{Luck}} 100% chance at 15 luck#Needles kill normal enemies instantly, bursting them into 10 tears#{{Damage}} Needles deal 3x Isaac's damage against bosses", -- Euthanasia
	...
	[C_ID .. 500] = "Spawns a sack every 5-6 rooms", -- Sack of Sacks
	...
	[C_ID .. 503] = "5% chance to shoot tears that instantly kill enemies#{{Luck}} 20% chance at 15 luck#Isaac deals 3.5 contact damage", -- Little Horn
	...
	[C_ID .. 543] = "Taking damage spawns a white poop#While inside the poop's aura:#↑ {{Tears}} x2 Tears multiplier#Chance to block damage", -- Hallowed Ground
	...
	[C_ID .. 549] = "{{EmptyBoneHeart}} Replaces all of Isaac's Red Heart containers with 6 empty Bone Hearts#Upon losing a Bone Heart:#↑ {{Tears}} +0.5 Tears#Shoots 8 bone tears in all directions", -- Brittle Bones
