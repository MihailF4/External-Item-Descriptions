...
local additionalCollectibleInformations = {
	...
	[C_ID .. 40] = "Causes a big explosion at Isaac's location#Deals 185 damage", -- Kamikaze!
	[C_ID .. 41] = "{{Fear}} Fears all enemies in the room for 5 seconds#Spawns a blue fly", -- Mom's Pad
	...
	[C_ID .. 49] = "The next shot is replaced with a beam#It deals 24x Isaac's damage over 0.83 seconds", -- Shoop da Whoop!
	...
	[C_ID .. 55] = "50% chance to shoot an extra tear backwards#{{Luck}} 100% chance at 5 luck", -- Mom's Eye
	[C_ID .. 59] = "{{Timer}} Receive for the room:#↑ {{Damage}} +2 Damage", -- The Book of Belial (Judas' Birthright)
	...
	[C_ID .. 83] = "Upon use:#{{HalfBlackHeart}} + Half Black Heart#{{Timer}} Receive for the room:#↑ {{Damage}} +2 Damage#↓ {{Speed}} -0.18 Speed#Isaac deals 40 contact damage per second#Allows Isaac to destroy rocks by walking into them", -- The Nail
	...
	[C_ID .. 87] = "25% chance to shoot in 4 directions#{{Luck}} 100% chance at 15 luck", -- Loki's Horns
	...
	[C_ID .. 98] = "{{SoulHeart}} Spawns 1 Soul Heart every 7-8 rooms", -- The Relic

    [C_ID .. 107] = "{{Timer}} Receive for the room:#Flight#Isaac's body separates from his head and attacks enemies with 23.5 contact damage per second", -- The Pinking Shears
    ...
    [C_ID .. 118] = "{{Chargeable}} Isaac's tears are replaced by a chargeable blood beam#{{Damage}} It deals 9x Isaac's damage over 0.63 seconds", -- Brimstone
    ...
    [C_ID .. 148] = "Taking damage spawns 2-6 blue flies", -- Infestation
    ...
    [C_ID .. 155] = "↑ {{Damage}} x1.35 Damage multiplier for the left eye#Floats around the room", -- The Peeper
    ...
    [C_ID .. 173] = "{{SoulHeart}} 33% chance that Red Hearts spawn as Soul Hearts instead", -- Mitre
	...
	[C_ID .. 192] = "{{Timer}} Receive for the room:#↑ {{Range}} +3 Range#Homing tears", -- Telepathy for Dummies
	...
	[C_ID .. 206] = "Isaac's head becomes an orbital that shoots, doesn't take damage and deals 56 contact damage per second", -- Guillotine
	[C_ID .. 211] = "Taking damage spawns 3-5 blue spiders", -- Spiderbaby
	[C_ID .. 219] = "{{Heart}} Taking damage has a 20% chance to spawn a Red Heart", -- Old Bandage
	...
	[C_ID .. 254] = "↑ {{Damage}} +1 Damage for the left eye#↑ {{Range}} +2.75 Range for the left eye", -- Blood Clot
	...
	[C_ID .. 272] = "Friendly exploding fly#The explosion deals 100 damage#{{Warning}} The explosion can hurt Isaac", -- BBF
	[C_ID .. 273] = "Dashes in the direction Isaac is shooting#Explodes when it hits an enemy#{{Poison}} The explosion deals 100 damage and poisons enemies#{{Warning}} The explosion can hurt Isaac", -- Bob's Brain
	[C_ID .. 275] = "{{Chargeable}} Familiar that charges and shoots a {{Collectible118}} blood beam#It deals 24 damage over 0.63 seconds", -- Lil Brimstone
	...
	[C_ID .. 287] = "Highlights tinted and crawlspace rocks in the room#{{Timer}} Receive one of these effects for the floor:#{{Collectible54}} Treasure Map#{{Collectible21}} Compass #{{Collectible246}} Blue Map#Only grants effects not already active#{{Collectible76}} If all effects are active, grants X-Ray Vision", -- Book of Secrets
	...
	[C_ID .. 293] = "{{Collectible118}} Shoot a 4-way blood beam#They each deal 200 damage over 1.33 seconds", -- Head of Krampus
	...
	[C_ID .. 316] = "Charged wave of 5 tears#{{Warning}} Taking damage while partially charged teleports Isaac to a random room", -- Cursed Eye
	...
	[C_ID .. 331] = "Homing tears#Tears gain an aura that deals 60 damage per second", -- Godhead
	[C_ID .. 344] = "{{Trinket41}} Spawns Match Stick", -- Match Book
	[C_ID .. 349] = "{{Coin}} 59% chance to spawn a random coin", -- Wooden Nickel
	...
	[C_ID .. 366] = "Isaac's bombs scatter into 4-5 tiny bombs", -- Scatter Bombs
	...
	[C_ID .. 374] = "10% chance to shoot holy tears, which spawn a beam of light on hit#{{Luck}} 50% chance at 9 luck#{{Damage}} The beams deals 3x Isaac's damage", -- Holy Light
	...
	[C_ID .. 415] = "If Isaac has no damaged heart containers:#↑ {{Damage}} x2 Damage multiplier#↓ {{Shotspeed}} -0.3 Shot speed#Taking any damage removes the effect for the room", -- Crown Of Light
	...
	[C_ID .. 426] = "Mimics Isaac's movement on a 0.66 second delay", -- Obsessed Fan
	[C_ID .. 430] = "Mimics Isaac's movement on a 0.66 second delay#{{Damage}} Shoots tears at nearby enemies that deal Isaac's damage", -- Papa Fly
	[C_ID .. 431] = "Mimics Isaac's movement on a 0.66 second delay#Tears that pass through it are doubled and gain a range + shot speed boost", -- Multidimensional Baby
	...
	[C_ID .. 442] = "While at 1 full Red Heart:#↑ {{Tears}} +2 Fire rate#↑ {{Range}} +1.5 Range#↑ {{Shotspeed}} +0.2 Shot speed", -- Dark Prince's Crown
	...
	[C_ID .. 459] = "20% chance to shoot a sticky booger#{{Damage}} Boogers deal Isaac's damage once a second and stick for 10 seconds#{{Luck}} Not affected by luck", -- Sinus Infection
	[C_ID .. 464] = "Room clear rewards and champion enemy drops become whatever pickup Isaac needs the most", -- Glyph of Balance
	[C_ID .. 468] = "Follows Isaac's movement on a 0.66 second delay#Deals 75 contact damage per second#{{Friendly}} After it deals 666 damage, it is absorbed by Isaac, increasing his contact damage and spawning friendly Chargers", -- Shade
	...
	[C_ID .. 487] = "{{EmptyHeart}} Removes 1 heart container for: #↑ {{Damage}} +0.2 Damage#{{Collectible73}} A Cube of Meat#{{Timer}} Receive for the room:#↑ {{Range}} +1.5 Range#{{Collectible214}} Leave a trail of blood creep", -- Potato Peeler
	[C_ID .. 489] = "Can be made to act as any die item (except {{Collectible723}} Spindown Dice) with the drop button ({{ButtonRT}})#Charge time varies based on the last die used and updates with every use", -- D Infinity
	[C_ID .. 491] = "{{Pill}} Spawns a random pill every 7 rooms#{{Poison}} Using a pill poisons all enemies in the room", -- Acid Baby
	...
	[C_ID .. 495] = "8% chance to shoot a blue fire that blocks enemy shots and deals contact damage#{{Luck}} 50% chance at 10 luck#Fires shrink and disappear after 2 seconds", -- Ghost Pepper
	[C_ID .. 496] = "3.33% chance to shoot a needle#{{Luck}} 25% chance at 13 luck#Needles kill normal enemies instantly, bursting them into 10 tears#{{Damage}} Needles deal 3x Isaac's damage against bosses", -- Euthanasia
	...
	[C_ID .. 500] = "Spawns a sack every 7-8 rooms", -- Sack of Sacks

	[C_ID .. 501] = "{{Heart}} +1 Heart container for every 25 coins Isaac has", -- Greed's Gullet
	[C_ID .. 503] = "5% chance to shoot a tear that summons a Big Horn hand#{{Luck}} 20% chance at 15 luck#The hand instantly kills enemies and deals 36 damage to bosses#Isaac deals 7 contact damage per second", -- Little Horn
	[C_ID .. 504] = "Spawns a fly that shoots at enemies#Each shot deals 3.5 damage", -- Brown Nugget
	...
	[C_ID .. 543] = "Taking damage spawns a white poop#While inside the poop's aura:#↑ {{Tears}} x2.5 Fire rate multiplier#↑ {{Damage}} x1.2 Damage multiplier#Homing tears#Chance to block damage", -- Hallowed Ground
	[C_ID .. 549] =	"{{EmptyBoneHeart}} Replaces all of Isaac's Red Heart containers with 6 empty Bone Hearts#Upon losing a Bone Heart:#↑ {{Tears}} +0.4 Fire rate#Shoots 8 bone tears in all directions", -- Brittle Bones
	...
	[C_ID .. 555] = "{{Timer}} Pay 5 {{Coin}} coins and receive for the room:#↑ {{Damage}} +1.2 Damage", -- Golden Razor
	[C_ID .. 556] = "{{Timer}} {{Collectible118}} Brimstone for the room#Using it multiple times in one room grants increased damage and a larger beam", -- Sulfur
	...
	[C_ID .. 588] = "{{BossRoom}} Reveals the location of the Boss Room#{{Timer}} When the floor boss is defeated, receive for the floor:#↑ {{Damage}} +3 Damage#↑ {{Luck}} +1 Luck#{{Card20}} The Sun effect#{{Battery}} Fully recharges the active item#{{CurseBlind}} Removes any curses", -- Sol
	...
	[C_ID .. 600] = "↑ {{Tears}} x1.4 Fire rate multiplier for the left eye", -- Eye Drops
	[C_ID .. 601] = "{{AngelChance}} Allows Angel Rooms to spawn even after taking a devil deal#Taking Red Heart damage doesn't reduce Devil/Angel Room chance as much", -- Act of Contrition
	...
	[C_ID .. 605] = "↑ {{Damage}} x1.35 Damage multiplier for the right eye#{{Timer}} Summons a Peeper familiar for the room, which leaves a trail of red creep", -- The Scooper
	[C_ID .. 606] = "5% chance to shoot tears that create rifts where they land#{{Luck}} 20% chance at 15 luck#Rifts do 3x Isaac's damage per second and pull in nearby enemies, pickups, and projectiles", -- Ocular Rift
	...
	[C_ID .. 616] = "8% chance to shoot a red fire that blocks enemy shots and deals contact damage#{{Luck}} 50% chance at 10 luck#Fires disappear after blocking 4 shots, dealing damage 4 times or after 10 seconds", -- Bird's Eye
	[C_ID .. 617] = "{{Magnetize}} 17% chance to shoot magnetizing tears#{{Luck}} 100% chance at 5 luck#Magnetized enemies attract nearby pickups, projectiles and enemies", -- Lodestone
	[C_ID .. 618] = "{{Bait}} 17% chance to shoot tears that mark enemies#{{Luck}} 100% chance at 5 luck#Marked enemies are targeted by other enemies", -- Rotten Tomato
	...
	[C_ID .. 625] = "Gigantifies Isaac and grants:#↑ {{Damage}} x4 Damage multiplier#↑ {{Range}} +2 Range#↓ {{Tears}} -1.9 Tears#Invincibility#Ability to crush enemies and obstacles#{{Timer}} Lasts for 30 seconds and persists between rooms and floors", -- Mega Mush
	[C_ID .. 626] = "Turns into a throwable knife that deals 25 damage when combined with {{Collectible627}} Knife Piece 2#The knife can open a door made of flesh", -- Knife Piece 1
	[C_ID .. 627] = "Turns into a throwable knife that deals 25 damage when combined with {{Collectible626}} Knife Piece 1#The knife can open a door made of flesh", -- Knife Piece 2
	...
	[C_ID .. 637] = "{{Confusion}} 10% chance to shoot a fist that inflicts confusion and extreme knockback#{{Luck}} 100% chance at 9 luck#Enemies take damage when they get knocked into a wall/obstacle", -- Knockout Drops
	...
	[C_ID .. 651] = "Slowly travels from the first room of the floor to the {{BossRoom}} Boss Room#Moves faster if you're ahead of it, and slower if you're behind it#Standing in its aura grants:#↑ {{Tears}} x2.5 Tears multiplier#↑ {{Damage}} x1.8 Damage multiplier#Homing tears#50% chance to ignore damage", -- Star of Bethlehem
	...
	[C_ID .. 655] = "Passively grants an orbital that blocks enemy shots and deals 10.5 contact damage per second#Using the item grants:#↑ {{Speed}} +0.5 Speed#Increases speed and damage of orbitals", -- Spin to Win
	...
	[C_ID .. 673] = "{{DevilRoom}} Entering a new floor after visiting a Devil Room and not taking any item/pickup grants:#↑ {{Damage}} +1 Damage#{{SoulHeart}} +1 Soul Heart", -- Redemption
	...
	[C_ID .. 704] = "{{Battery}} Charges with damage dealt#{{Timer}} Receive for 5 seconds:#↑ {{Speed}} +0.4 Speed#↓ {{Tears}} x0.5 Fire rate multiplier#↑ {{Tears}} +2 Fire rate#↑ {{Damage}} +3 Damage#Restricts attacks to a melee that reflects shots#{{Timer}} Each kill increases the duration by 1 second and grants brief invincibility", -- Berserk!
	[C_ID .. 705] = "{{Timer}} Receive for 1 second (or until shooting):↑ {{Speed}} +1 Speed#Isaac can pass through enemies/projectiles and paralyzes them#When the effect ends, damages paralyzed enemies, removes paralyzed projectiles and creates a blast at Isaac's location#The attacks and blast are more powerful the more enemies/projectiles have been hit", -- Dark Arts
	...
	[C_ID .. 716] = "{{Shop}} Spending 3 coins grants either:#↑ {{Speed}} +0.03 Speed#↑ {{Damage}} +0.5 Damage#↑ {{Range}} +0.25 Range", -- Keeper's Sack
...
local repCollectibles={
	...
	[79] = {"79", "The Mark", "↑ {{Damage}} +1 Damage#↑ {{Speed}} +0.2 Speed#{{BlackHeart}} +1 Black Heart"}, -- The Mark
	...
	[274] = {"274", "Best Bud", "Taking damage spawns one midrange orbital for the room#Deals 150 contact damage per second"}, -- Best Bud
	...
	[288] = {"288", "Box of Spiders", "Spawns 4-8 blue spiders"}, -- Box of Spiders
...
EID.descriptions[languageCode].TearFlagNames = {
	[TearFlags.TEAR_SPECTRAL] = "spectral",                 -- Ouija board type tear (goes thru obstacles)
    [TearFlags.TEAR_PIERCING] = "piercing",                 -- Cupid's arrow type tear (goes thru enemy)
    [TearFlags.TEAR_HOMING] = "homing",                   -- Spoon bender type tear (homes to enemy)
    [TearFlags.TEAR_SLOW] = "slowing",                  -- Spider bite type tear (slows on contact)
    [TearFlags.TEAR_POISON] = "poison",                   -- Common cold type tear (poisons on contact)
    [TearFlags.TEAR_FREEZE] = "petrify",                  -- Mom's contact type tear (freezes on contact)
    [TearFlags.TEAR_SPLIT] = "split",                    -- Parasite type tear (splits on collision)
    [TearFlags.TEAR_GROW] = "grow by range",            -- Lump of coal type tear (grows by range)
    [TearFlags.TEAR_BOOMERANG] = "boomerang",                -- My reflection type tear (returns back)
    [TearFlags.TEAR_PERSISTENT] = "persistent",               -- Polyphemus type tear (Damages the entity and if the damage is more then enemy hp it continues with less damage
    [TearFlags.TEAR_WIGGLE] = "wiggle movement",         -- Wiggle worm type tear (wiggles)
    [TearFlags.TEAR_MULLIGAN] = "spawn fly on hit",        -- Mulligan type tear (creates fly on hit)
    [TearFlags.TEAR_EXPLOSIVE] = "explosive",               -- IPECAC type tear (explodes on hit)
    [TearFlags.TEAR_CHARM] = "charming",                -- Mom's Eyeshadow tear
    [TearFlags.TEAR_CONFUSION] = "confusion",               -- Iron Bar tear
    [TearFlags.TEAR_HP_DROP] = "enemies drop hearts",     -- These tears cause enemy to drop hearts if killed (33% chance)
    [TearFlags.TEAR_ORBIT] = "orbit around player",     -- Used for Little Planet (orbit arounds the player)
    [TearFlags.TEAR_WAIT] = "Anti-Gravity",     	      -- Anti gravity type tear (floats in place for some time before finally moving) (unset after first update)
    [TearFlags.TEAR_QUADSPLIT] = "split into 4 on hit",     -- Splits into 4 smaller tears if it hits the ground
    [TearFlags.TEAR_BOUNCE] = "bounce of enemies",       -- Bounce off of enemies, walls, rocks (Higher priority than PERSISTENT & PIERCING)
    [TearFlags.TEAR_FEAR] = "fear",                    -- Mom's Perfume type tear of fear (fear on contact)
    [TearFlags.TEAR_SHRINK] = "shrink",                  -- Proptosis tears start large and shrink
    [TearFlags.TEAR_BURN] = "burn",                    -- Fire Mind tears cause Burn effect on enemies
    [TearFlags.TEAR_ATTRACTOR] = "enemy and pickup magnet", -- Attracts enemies and pickups
    [TearFlags.TEAR_KNOCKBACK] = "knockback",               -- Tear impact pushes enemies back further
    [TearFlags.TEAR_PULSE] = "pulsating",               -- Makes the tear pulse
    [TearFlags.TEAR_SPIRAL] = "spiral movement",         -- Makes the tear path spiral
    [TearFlags.TEAR_FLAT] = "oval shape",              -- Makes the tear oval in the direction of travel
    [TearFlags.TEAR_SAD_BOMB] = "sad bomb",                -- Used by Bombs (Sad Bomb)
    [TearFlags.TEAR_BUTT_BOMB] = "butt bomb",               -- Used by Bombs (Butt Bomb)
    [TearFlags.TEAR_SQUARE] = "square movement",         -- Used for Hook Worm
    [TearFlags.TEAR_GLOW] = "damage dealing aura",     -- Used for GodHead (they will have a glow around them)
    [TearFlags.TEAR_GISH] = "slowing + color enemy black", -- Used for Gish player tears (to color enemy black on slowing)
    [TearFlags.TEAR_MYSTERIOUS_LIQUID_CREEP] = "green creep on hit", -- Mysterious Liquid tears spawn damaging green creep when hit
    [TearFlags.TEAR_SHIELDED] = "shielded",                -- Lost Contact tears, block enemy projectiles
    [TearFlags.TEAR_GLITTER_BOMB] = "glitter bomb",            -- Used by Bombs (Glitter Bomb)
    [TearFlags.TEAR_SCATTER_BOMB] = "scatter bomb",            -- Used for Scatter bombs
    [TearFlags.TEAR_STICKY] = "sticky",                  -- Used for Sticky bombs and Explosivo tears
    [TearFlags.TEAR_CONTINUUM] = "loops around screen",     -- Tears loop around the screen
    [TearFlags.TEAR_LIGHT_FROM_HEAVEN] = "spawn light beam on hit", -- Create damaging light beam on hit
    [TearFlags.TEAR_COIN_DROP] = "coin drop on hit",        -- Used by Bumbo, spawns a coin when tear hits
    [TearFlags.TEAR_BLACK_HP_DROP] = "black hp drop on hit",    -- Enemy drops a black hp when dies
    [TearFlags.TEAR_TRACTOR_BEAM] = "tractor beam",            -- Tear with this flag will follow parent player's beam
    [TearFlags.TEAR_GODS_FLESH] = "shrink enemies",          -- God's flesh flag to minimize enemies
    [TearFlags.TEAR_GREED_COIN] = "create coin on hit",      -- Greed coin tears that has a chance to generate a coin when hit
    [TearFlags.TEAR_CROSS_BOMB] = "cross bomb",              -- Bomber Boy
    [TearFlags.TEAR_BIG_SPIRAL] = "big spiral movement",     -- Ouroboros Worm, big radius oscilating tears
    [TearFlags.TEAR_PERMANENT_CONFUSION] = "permanent confusion on hit",   -- Glaucoma tears, permanently confuses enemies
    [TearFlags.TEAR_BOOGER] = "booger",                  -- Booger tears, stick and do damage over time
    [TearFlags.TEAR_EGG] = "spawn spiders or fly on hit",               -- Egg tears, leave creep and spawns spiders or flies
    [TearFlags.TEAR_ACID] = "can break grid entities on hit",            -- Sulfuric Acid tears, can break grid entities
    [TearFlags.TEAR_BONE] = "spawn 1-2 bone shards on enemy death",                    -- Bone tears, splits in 2
    [TearFlags.TEAR_BELIAL] = "piecing + gain double damage & homing afterwards", -- Belial tears, piecing tears gets double damage + homing
    [TearFlags.TEAR_MIDAS] = "turn enemies into gold on touch",           -- Midas touch tears
    [TearFlags.TEAR_NEEDLE] = "burst into 10 tears on hit",                -- Needle tears
    [TearFlags.TEAR_JACOBS] = "electricity on hit",           -- Jacobs ladder tears
    [TearFlags.TEAR_HORN] = "Summon big horn hand on hit", -- Little Horn tears
    [TearFlags.TEAR_LASER] = "connected with electricity",   -- Technology Zero
    [TearFlags.TEAR_POP] = "bounces of eachother",        -- Pop!
    [TearFlags.TEAR_ABSORB] = "absorb others",               -- Hungry Tears
    [TearFlags.TEAR_LASERSHOT] = "lasershot",               -- Trisagion, generates a laser on top of the tear
    [TearFlags.TEAR_HYDROBOUNCE] = "skip on ground",          -- Flat Stone
    [TearFlags.TEAR_BURSTSPLIT] = "burst split",             -- Haemolacria
    [TearFlags.TEAR_CREEP_TRAIL] = "creep trail",             -- Bob's Bladder
    [TearFlags.TEAR_PUNCH] = "punch effect on hit",     -- Knockout Drops
    [TearFlags.TEAR_ICE] = "freeze enemy on death",   -- Uranus
    [TearFlags.TEAR_MAGNETIZE] = "enemy and pickup magnet", -- Lodestone
    [TearFlags.TEAR_BAIT] = "bait effect on hit",       -- Rotten Tomato
    [TearFlags.TEAR_OCCULT] = "Eye of the Occult",       -- Eye of the Occult
    [TearFlags.TEAR_ORBIT_ADVANCED] = "narrow orbit movement",   -- Orbiting tears with a more narrow and stable orbit (used by Saturnus and Immaculate Heart)
    [TearFlags.TEAR_ROCK] = "break rocks",             -- Rock tears, chance to break rocks, deal extra damage to rock type enemies
    [TearFlags.TEAR_TURN_HORIZONTAL] = "90 degree movement",      -- Brain Worm, tears turn and go horizontally when moving past an enemy
    [TearFlags.TEAR_BLOOD_BOMB] = "blood bomb",              -- Blood Bombs, leave blood creep on the ground
    [TearFlags.TEAR_ECOLI] = "turn enemy into poop",    -- E. Coli tears, turn enemies into poop
    [TearFlags.TEAR_COIN_DROP_DEATH] = "coin drop on death",      -- Killed enemies have a chance to drop a random coin (Reverse Hanged Man)
    [TearFlags.TEAR_BRIMSTONE_BOMB] = "brimstone bomb",          -- Brimstone Bombs, explosion creates a brimstone cross
    [TearFlags.TEAR_RIFT] = "black hole on hit",       -- Rift tears, creates a black hole on impact
    [TearFlags.TEAR_SPORE] = "stick to enemy and multiply on enemy death",  -- Spore tears, stick to enemies and multiply on enemy death
    [TearFlags.TEAR_GHOST_BOMB] = "ghost bomb",              -- Ghost bombs
    [TearFlags.TEAR_CARD_DROP_DEATH] = "card drop on death",      -- Killed enemies will drop a random tarot card
    [TearFlags.TEAR_RUNE_DROP_DEATH] = "rune drop on death",      -- Killed enemies will drop a random rune
    [TearFlags.TEAR_TELEPORT] = "teleport enemy on hit",   -- Hit enemies will teleport to a different part of the room
    [TearFlags.TEAR_DECELERATE] = "decelerate over time",    -- Decelerate over time
    [TearFlags.TEAR_ACCELERATE] = "accelerate over time",    -- Accelerate over time
    
	[TearFlags.TEAR_BOUNCE_WALLSONLY] = "bounce (walls only)",    -- Similar to TEAR_BOUNCE but only bounces off walls, not enemies
	[TearFlags.TEAR_BACKSTAB] = "extra damage from behind + bleeding",   -- Deals extra damage from behind and inflicts bleeding

	-- TODO: More Tearflags missing here
}
